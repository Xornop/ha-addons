...
5. Install can take a couple minutes and might seem stuck on installing. The library is fairly large and will be downloaded. If installation has failed, it will show in your logs, otherwise be patient!
